    ...
    <>
      <section className="about__header">
        <div className="container-fluid header__wrapper">
          <div className="row">
            <div className="col-sm-12 col-md-12 col-lg-12 col-xl-12 banner"></div>
          </div>
          <div className="row">
            <div className="col-sm-4 col-md-4 col-lg-4 col-xl-4 about__meta meta__purple">
              ...
              <div className="meta__info">
                ...
                <p>
                  ...
                  techniques, business strategies, and more. We have collected.
                </p>
              </div>
            </div>
            <div className="col-sm-4 col-md-4 col-lg-4 col-xl-4 about__meta meta__red">
              ...
              <div className="meta__info">
                ...
                <h3>courses</h3>
                <p>
                  Sign up and find out for yourself why so many people are
                  taking and recommending this course. I genuinely believe.
                </p>
              </div>
            </div>
            <div className="col-sm-4 col-md-4 col-lg-4 col-xl-4 about__meta meta__orange">
              ...
              <div className="meta__info">
                ...
                <h3>in courses</h3>
                <p>
                  Get unlimited access to 2,000 of Udemy’s top courses for your
                  team. Teach what you love. Udemy gives you the tools.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="col-md-6">
              <div className="contact_content">
                ...
                <blockquote className="blockquote">
                  Our grantees and partners generosity truth, prevention
            ...
            <div className="col-sm-12 col-md-12 col-lg-12 col-xl-12">
              ...
              <div className="row certi__content">
                ...
                <div className="col-sm-3 col-md-3 col-lg-3 col-xl-3 certi__item">
                  ...
                  <p>
                    Enroll in online classes taught by creators from around the
                    world.
                  </p>
                </div>
              </div>
            ...
            <div className="col-md-4 pl-0 pr-3">
              <div className="team__item">
                ...
                <div className="team__content">
                  ...
                  <p>
                    Our grantees and partners generosity truth, prevention
                    nutrition involvement Ford Foundation. Enabler agenda
                    results global leaders.
                  </p>
                </div>
              </div>
            </div>
