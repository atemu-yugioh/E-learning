      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-sm-3 col-md-3 col-lg-3 col-xl-3 pl-0 new">
            ...
            <ul>
              <li>
                <i className="fas fa-caret-right" /> Branding like a
                professional in
              </li>
              <li>
                <i className="fas fa-caret-right" /> Become a Professional
                Graphic
              </li>
              <li>
                <i className="fas fa-caret-right" /> Sketch 3 from A to
              </li>
              <li>
                <i className="fas fa-caret-right" /> French for Beginners to
                Advanced
              </li>
              <li>
                <i className="fas fa-caret-right" /> Typography and Lettering
                for Logo
              </li>
              <li>
                <i className="fas fa-caret-right" /> Adobe InDesign CS6 Tutorial
                Beginners
              </li>
              <li>
                <i className="fas fa-caret-right" /> Sketch 3 from A to
        ...
        <div className="row copyright">
          <div className="col-sm-8 col-md-8 col-lg-8 col-xl-8 px-0">
            © 2017 BoxShop. All Rights Reserved By Noname
          </div>
