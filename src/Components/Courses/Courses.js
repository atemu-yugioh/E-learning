        ...
        <div className="container">
          <div className="row sort__filter align-items-center">
            <div className="col-sm-6 col-md-6 col-lg-6 col-xl-6 pl-0">
              <div className="sort">
                <span onClick={() => this.handleDisplay("grid")}>
                  <i
                    className={`fas fa-th ${
                ...
                <span onClick={() => this.handleDisplay("list")}>
                  <i
                    className={`fas fa-th ${
                      this.state.display === "list" ? "active" : ""
                    }`}
                  />
                </span>
            ...
            <div className="col-sm-6 col-md-6 col-lg-6 col-xl-6 text-right pr-0">
              <div className="filter">
                <span className="pr-4 showing">
                  Showing 1–{this.props.children.props.children.length} of{" "}
                  {this.props.children.props.children.length} results
                </span>
                <span className="pl-4 filter__bar">
                  <a href="#1">
                    Filter <i className="fas fa-bars" />
                  </a>
                </span>
              </div>
            </div>
