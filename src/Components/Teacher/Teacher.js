      ...
      <div className="container-fluid">
        <div className="row teacher__wrapper">
          <div className="col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <h3 className="title" style={{ margin: "2%" }}>
          ...
          <div className="col-sm-2 col-md-2 col-lg-2 col-xl-2">
            <div className="teacher__item">
              <div className="teacher__img">
                <img src="/img/teacher2.jpg" alt="teacher" />
              </div>
              <div className="teacher__info">
          ...
          <div className="col-sm-2 col-md-2 col-lg-2 col-xl-2">
            <div className="teacher__item">
              <div className="teacher__img">
                <img src="/img/teacher3.jpg" alt="teacher" />
              </div>
              <div className="teacher__info">
          ...
          <div className="col-sm-2 col-md-2 col-lg-2 col-xl-2">
            <div className="teacher__item">
              <div className="teacher__img">
                <img src="/img/teacher4.jpg" alt="teacher" />
              </div>
              <div className="teacher__info">
                <h5>Robert Downy</h5>
          ...
          <div className="col-sm-2 col-md-2 col-lg-2 col-xl-2">
            <div className="teacher__item">
              <div className="teacher__img">
                <img src="/img/teacher5.jpg" alt="teacher" />
              </div>
              <div className="teacher__info">
          ...
          <div className="col-sm-2 col-md-2 col-lg-2 col-xl-2">
            <div className="teacher__item">
              <div className="teacher__img">
                <img src="/img/teacher6.jpg" alt="teacher" />
              </div>
              <div className="teacher__info">
                <h5>Barbara Doley</h5>
