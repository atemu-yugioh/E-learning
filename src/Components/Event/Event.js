                ...
                <div className="countdown__event">
                  <div className="countdown__timer">
                    <div className="countdown__section">
                      <div className="countdown__amount countdown__days">
                        101
                      </div>
                      <div className="countdown__period">DAYS</div>
                    </div>
                    <div className="countdown__section">
                      <div className="countdown__amount countdown__hours">
                        {this.state.hours}
                      </div>
                      <div className="countdown__period">HOURS</div>
                    </div>
                    <div className="countdown__section">
                      <div className="countdown__amount countdown__minutes">
                        {this.state.minutes}
                      </div>
                      <div className="countdown__period">MINUTES</div>
                    </div>
                    <div className="countdown__section">
                      <div className="countdown__amount countdown__seconds">
                        {this.state.seconds}
                      </div>
                  ...
                  <h3 className="countdown__subtitle">
              ...
              <div className="col-sm-8 col-md-8 col-lg-8 col-xl-8 ticket__right">
                <div className="ticket__content">
                  <h3 class="ticket__title">
                    WHAT IS BUSINESS CONFERENCE 2019
                  </h3>
                  <h4 class="ticket__sub__title">
                    Where The Business World Meets
                  </h4>
                </div>
                <p>
                  Conference dolor sit amet, consectetur adipisicing elit, sed
                ...
                <div className="ticket__btn">
                  <button class="buy__btn">Buy Ticket</button>
                  <button class="knowmore__btn">Know More</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="events_speaker">
          <div className="container speaker__wrapper">
            <div className="row speakers">
              <h3 class="speaker__title">Who's Speaking?</h3>
