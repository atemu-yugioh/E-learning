      ...
      <div className="product__item">
        ...
        <div className="sub__info">
          <div className="info__content">
            ...
            <div className="meta">
              <div>
                <i className="fas fa-signal" /> Advanced
              </div>
              <div>
                <i className="fas fa-list-ul" /> 6 Lectures
              </div>
              <div>
                <i className="far fa-clock" /> 6 Hours
              </div>
            </div>
            {this.state.showGoCart ? (
              ...
              <button onClick={() => this.onAdd(course)} className="add__cart">
                ADD TO CART
              </button>
            )}
