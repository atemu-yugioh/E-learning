              ...
              <div className="knowledge">
                ...
                <div className="row">
                  <div className="col-sm-6 col-md-6 col-lg-6 col-xl-6 ">
                    <ul>
                      <li>
                        <i className="fas fa-check" /> Learn to use Python
                        professionally, learning both Python 2 and Python 3!
                      </li>
                      <li>
                        <i className="fas fa-check" /> Learn advanced Python
                        features, like the collections module and how to work
                        with timestamps!
                      </li>
                      <li>
                        <i className="fas fa-check" /> Understand complex
                        topics, like decorators.
                      </li>
                      <li>
                        <i className="fas fa-check" /> Get an understanding of
                  ...
                  <div className="col-sm-6 col-md-6 col-lg-6 col-xl-6 ">
                    <ul>
                      <li>
                        <i className="fas fa-check" /> Create games with Python,
                        like Tic Tac Toe and Blackjack!
                      </li>
                      <li>
                        <i className="fas fa-check" /> Learn to use Object
                        Oriented Programming with classes!
                      </li>
                      <li>
                        <i className="fas fa-check" /> Understand how to use
                        both the Jupyter Notebook and create .py files
                      </li>
                      <li>
                        <i className="fas fa-check" /> Build a complete
                    ...
                    <div className="section__entry">
                      ...
                      <div className="lessons">
                        <div className="lessons__header">
                          ...
                          <ul>
                            <li>
                              <i className="fas fa-play-circle" /> How to obtain
                              your Certificate of Completion for this course
                              <span>
                                <i className="far fa-clock" /> 15:32
                              </span>
                            </li>
                            <li>
                              <i className="fas fa-play-circle" /> Working Files
                              – Download These First
                              <span>
                                <i className="far fa-clock" /> 14:24
                              </span>
                            </li>
                          </ul>
                        </div>
                    ...
                    <div className="section__entry">
                      ...
                      <div className="lessons">
                        <div className="lessons__header">
                          ...
                          <ul>
                            <li>
                              <i className="fas fa-play-circle" /> Get In Total
                            ...
                            <li>
                              <i className="fas fa-play-circle" /> The Magic Of
                              Auto Recovery
                              <span>
                                <i className="far fa-clock" /> 15:32
                              </span>
                            ...
                            <li>
                              <i className="fas fa-play-circle" /> Customize The
                              Workspace
                              <span>
                                <i className="far fa-clock" /> 15:32
                              </span>
                      ...
                      <div className="lessons">
                        <div className="lessons__header">
                          ...
                          <ul>
                            ...
                            <li>
                              <i className="fas fa-play-circle" /> Creating
              ...
              <div className="sidebar__info">
                ...
                <div className="info__inner">
                  ...
                  {this.state.showGoCart ? (
                    ...
                    <button className="add" onClick={() => this.onAdd(course)}>
                      ADD TO CART
                    </button>
                  )}
