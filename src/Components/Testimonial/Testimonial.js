            ...
            <div className="col-sm-6 col-md-6 col-lg-6 col-xl-6 testi__left pl-0">
              <div className="testi__wrapper">
                ...
                <div className="testi__info">
                  ...
                  <p>
                    <i className="fas fa-quote-left" /> Had the privilege of
                    working with this great team in Kiev &amp; I am impressed
                    with their progress. With more than 10K courses, this team
                    is going places. <i className="fas fa-quote-right" />
                  </p>
