          ...
          <div className="row feature__content">
            <div className="col-sm-4 col-md-4 col-lg-4 col-xl-4 feature__left pl-0">
              <div className="feature__box">
                ...
                <ul>
                  <li>
                    <i className="fas fa-check" /> 4,042 VIDEO COURSES
                  </li>
                  <li>
                    <i className="fas fa-check" /> UNLIMITED ACCESS
                  </li>
                  <li>
                    <i className="fas fa-check" /> EXPERT TEACHERS
                  </li>
                  <li>
                    <i className="fas fa-check" /> VARIETY OF INSTRUCTION
                  </li>
                  <li>
                    <i className="fas fa-check" /> ON-THE-GO-LEARNING
                  </li>
                  <li>
                    <i className="fas fa-check" /> PASSIONATE EDUCATORS
                  </li>
                  <li>
                    <i className="fas fa-check" /> TRUSTED SOURCE
                  </li>
                </ul>
              </div>
            </div>
