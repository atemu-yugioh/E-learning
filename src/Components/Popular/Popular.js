          ...
          <div className="row">
            <div className="col-sm-12 col-md-12 col-lg-12 col-xl-12 popular__content">
              <ul className="nav nav-pills">
                ...
                <li className="nav-item">
                  <a className="nav-link" data-toggle="pill" href="#design">
                    Design
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" data-toggle="pill" href="#business">
                    Business
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" data-toggle="pill" href="#it">
                    IT &amp; Sofware
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" data-toggle="pill" href="#science">
                    Computer Science
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" data-toggle="pill" href="#marketing">
                    Marketing
                  </a>
                </li>
                <li className="nav-item">
                ...
                <li className="viewall">
                  <Link to="/courses">
                    View All <span className="lnr lnr-arrow-right" />
                  </Link>
                </li>
              </ul>
